				...
				<form method="POST" action="/input">
					...
					<div class="form-group">
						<div class="input-group">
							<input max="5" maxlength="5" class="form-control" width="5" name="amount1" placeholder="How much did you drink, in milliliters" aria-describedby='input-addon'>
		...
		<div class="panel panel-default">
			...
			<div class="panel-footer">
				<form method="POST" action="/output">
					...
					<div class="form-group">
						<div class="input-group">
							<input class="form-control" name="amount1" placeholder="How much did you expel, in milliliters" aria-describedby='output-addon'>
		...
		<div class="panel panel-default">
			...
			<div class="panel-footer">
				<form method="POST" action="/bp">
					{{ csrf_field() }}
					<div class="form-group">
						<input class="form-control" name="amount1" placeholder="Enter systolic">
						<input class="form-control" name="amount2" placeholder="Enter distolic">
